...
namespace Komunala
{
    public partial class frmCeniko_Izpis : Form
    {
        ...
        {
            // Korekcija cen
            TextObject tt4 = (TextObject)crpt.ReportDefinition.Sections["Section1"].ReportObjects["ttekst_o_1"];
            tt4.Text = frmMain.tekst_o_1;
            // direktor
            ...
            string str_tmp = "Gornja Radgona, " + frmMain.datum_o_1;
            TextObject tt6 = (TextObject)crpt.ReportDefinition.Sections["Section1"].ReportObjects["tdatum_o_2"];
            tt6.Text = str_tmp;
            // velja od
            str_tmp = "Cenik velja od " + frmMain.datum_o_2;
            TextObject tt7 = (TextObject)crpt.ReportDefinition.Sections["Section4"].ReportObjects["tdatum_o_1"];
            tt7.Text = str_tmp;
            // nad prvo stranjo cenika
            TextObject tt8 = (TextObject)crpt.ReportDefinition.Sections["Section1"].ReportObjects["ttekst_o_2"];
            tt8.Text = frmMain.tekst_o_2;
        }

        private void frmCeniko_Izpis_Load(object sender, EventArgs e)
        {
            Zacasna_tabela();
            try
            {
