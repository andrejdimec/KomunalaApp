...
namespace Komunala
{
    public partial class frmSkupine : Form
    {
        ...
        private void frmSkupine_Load(object sender, EventArgs e)
        {
            onemogoci_tb();
            Grid();
            Display();
        ...
        {
            tb2.Text = dgv1.SelectedCells[1].Value.ToString();
            tb1.Text = dgv1.SelectedCells[2].Value.ToString();
        ...
        private void dgv1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            tid = Convert.ToInt32(index);
            tb2.Text = dgv1.Rows[e.RowIndex].Cells[1].Value.ToString();
            tb1.Text = dgv1.Rows[e.RowIndex].Cells[2].Value.ToString();
            Spremeni();
        }
