...
namespace Komunala
{
    public partial class frmObcinaCenik : Form
    {
        ...
        private void frmObcinaCenik_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (ne_shrani == 0)
            {
                ...
                try
                {
                    ...
                    if (dodajanje == true)
                    {
                        ...
                        // dodaj
                        q = "insert into tbl_Cenik(storitev,em,cena_obcina,skupina) values(@tstoritev,@tem,@tcenao,@tskupina)";
                        cmd = new SqlCommand(q, con);
                        con.Open();
                    ...
                    //  else
                    {
                        ...
                        q = "update tbl_Cenik set storitev=@tstoritev, em = @tem, cena_obcina=@tcenao, skupina=@tskupina where id=@tid";
                        cmd = new SqlCommand(q, con);
                        con.Open();
                        cmd.Parameters.AddWithValue("@tstoritev", id_storitev);
                        cmd.Parameters.AddWithValue("@tem", id_enota);
