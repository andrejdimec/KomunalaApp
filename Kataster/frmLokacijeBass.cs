...
namespace Komunala.Kataster
{
    public partial class frmLokacijeBass : Form
    {
        ...
        private void Grid()
        {
            ...
            dgv1.Columns[0].Name = "Odjemno mesto";
        ...
        private void Nalozi_zapis(int idx_om, int idx_placnik)
        {
            string pl_naziv = "";
            string pl_naslov = "";
            string pl_ptt = "";
            ...
            try
            {
                ...
                cmdb2.Parameters.AddWithValue("@idx", idx_placnik);
                conb2.Open();
                rdrb2 = cmdb2.ExecuteReader();
                while (rdrb2.Read())
                {
                    if (rdrb2["naziv"] != DBNull.Value) pl_naziv = (string)rdrb2["naziv"];
                    if (rdrb2["naslov"] != DBNull.Value) pl_naslov = (string)rdrb2["naslov"];
                    if (rdrb2["ptt"] != DBNull.Value) pl_ptt = (string)rdrb2["ptt"];
                    if (rdrb2["kraj"] != DBNull.Value) pl_kraj = (string)rdrb2["kraj"];
                    if (rdrb2["drzava_naziv"] != DBNull.Value) pl_drzava = (string)rdrb2["drzava_naziv"];
                    //if (rdrb2["zr"] != DBNull.Value) pl_zr = (string)rdrb2["zr"];
                    if (rdrb2["pravna_os"] != DBNull.Value) pl_pravna = (string)rdrb2["pravna_os"];
                    if (rdrb2["zavezanec"] != DBNull.Value) pl_ddv = (string)rdrb2["zavezanec"];
        ...
        private void dgv1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Nalozi_zapis(idx_om, idx_placnik);
        ...
        private void Display()
        {
            ...
            try
            {
                ...
                while (rdrb.Read())
                {
                    ...
                    string[] row1 = new string[] { om_naziv, omulica + " " + omhs + omhd,omkraj, omplacnik,plnaslov,plposta,omulica+omhs+omhd,omhs,omhd,omid,placnik_id };
